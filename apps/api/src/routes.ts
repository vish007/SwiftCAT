...
import { loginSchema, paginateScenarios } from '@swiftcat/shared';
import { prisma } from './prisma.js';
import { getScenarioById, listScenarios } from './demoRepository.js';

function resolveCorrelationId(headers: Record<string, unknown>): string {
